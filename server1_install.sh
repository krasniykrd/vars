...
sshpass -p $SERVER2_PASS sftp -o StrictHostKeyChecking=no root@SERVER2_IP:/root/easy-rsa/easyrsa3/pki/s2s.crt
sshpass -p $SERVER2_PASS sftp -o StrictHostKeyChecking=no root@SERVER2_IP:/root/easy-rsa/easyrsa3/pki/s2s.key
...
cp -f /root/vars/client.conf /root/easy-rsa/easyrsa3
sed -i 's/#SERVER#/$SERVER_IP/' /root/easy-rsa/easyrsa3/client.conf
zip -9 /root/configs/client.zip /root/easy-rsa/easyrsa3/pki/ca.crt /root/easy-rsa/easyrsa3/pki/issued/client.crt /root/easy-rsa/easyrsa3/pki/private/client.key /root/easy-rsa/easyrsa3/pki/dh.pem
cd /root/configs
